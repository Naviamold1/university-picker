...
{#if href}
	...
	>
		...
		<span
			class="backdrop bg-secondary absolute inset-[0.9px] rounded-md transition-colors duration-200 group-hover:bg-neutral-200 dark:bg-neutral-900 dark:group-hover:bg-neutral-900"
		></span>
		<span class="text-primary z-10 text-center text-sm font-medium">
			{@render children?.()}
		</span>
	</a>
{:else}
